...
function BakedGoods() {
  return (
    <div className='container'>
      <h1 id='bakedTitle' className='d-flex justify-content-center pb-5'>
        Baked Goods
      </h1>
          ...
          <div className='carousel-inner'>
            <div className='carousel-item active'>
              <img
                ...
                src={require('../../assets/images/carousel/IMG_7872.jpg')}
                alt='bakedgoods0'
              />
            </div>
            ...
            <div className='carousel-item'>
              <img
                className='d-block w-50 mx-auto'
                src={require('../../assets/images/carousel/IMG_7899.jpg')}
                alt='bakedgoods'
              />
            ...
            <div className='carousel-item'>
              <img
                className='d-block w-50 mx-auto pics'
                src={require('../../assets/images/carousel/IMG_7895.jpg')}
                alt='backedgoods1'
              />
              <div className='carousel-caption'>
            ...
            <div className='carousel-item'>
              <img
                className='d-block w-50 mx-auto pics'
                src={require('../../assets/images/carousel/IMG_7889.jpg')}
                alt='bakedgoods2'
              />
              <div className='carousel-caption'>
            ...
            <div className='carousel-item'>
              <img
                className='d-block w-50 mx-auto pics'
                src={require('../../assets/images/carousel/IMG_7870.jpg')}
                alt='backedgoods3'
              />
              <div className='carousel-caption'>
      ...
      <p className='quote d-flex justify-content-center pt-3'>
        "Everything I make is custom. I take what ideas my clients have and turn
        them into delicious edible art pieces." -Wendy R.
      </p>
    </div>
  );
}
